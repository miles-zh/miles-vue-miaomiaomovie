<template>
    <div>
        <footer id="footer">
			<ul>
				<router-link tag="li" to='/movie' class="cursor">
...
<style scoped>
	#footer{ width:100%; height:50px; background: #456788; border-top:2px #ebe8e3 solid; position: fixed; left: 0; bottom:0;color:#fff; }
	#footer ul{ display: flex; text-align: center; height:50px; align-items:center;}
	#footer ul li{ flex:1; height:40px;cursor: pointer;}
